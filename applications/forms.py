...
class PrincipleLicenceForm(forms.ModelForm):
    ...
    county = forms.CharField(label='County', required=True,  widget=forms.TextInput(attrs={'class': 'form-control ', 'name':'county', 'id':'county','type':'text' }))
    parish = forms.CharField(label='Parish', required=True,  widget=forms.TextInput(attrs={'class': 'form-control ', 'name':'parish', 'id':'parish','type':'text' }))
    sub_county = forms.CharField(label='Sub County', required=True,  widget=forms.TextInput(attrs={'class': 'form-control ', 'name':'sub_county', 'id':'sub_county','type':'text' }))
    village = forms.CharField(label='Village', required=True,  widget=forms.TextInput(attrs={'class': 'form-control ', 'name':'village', 'id':'village','type':'text' }))
    ...
    coperate_social_responsibility = forms.FileField(label='Corporate Social Responsibility Program',  required=True, widget=forms.FileInput(attrs={'class': 'form-control', 'name':'coperate_social_responsibility', 'id':'coperate_social_responsibility','type':'file' }))
...
class PremisesForm(forms.ModelForm):
    ...
    district = forms.ChoiceField(label='District',  required=True, choices= districts, widget=forms.Select(attrs={'class': 'form-control', 'name':'district', 'id':'district','type':'text'}))
    
    region = forms.ChoiceField(label='Region',  required=True,  choices=REGION_CHOICES,  widget=forms.Select(attrs={'class': 'form-control', 'name':'region', 'id':'region','type':'text'}))
