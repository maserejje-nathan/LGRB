...
urlpatterns = [
    ...
    # prn 
    path('payments/prns', LicencePrns.as_view(), name="new_prn_list"),
    # employee 
    path('prn/pdf/employee/list/<int:pk>', employee_prn_pdf_view, name="new_employee_prn_pdf_view"),
    path('prn/pdf/employee/download/<int:pk>', new_employee_prn_pdf_download_view, name="new_employee_prn_pdf_download_view"),
    # principle
    # application fees
    path('prn/pdf/principle/list/<int:pk>', principle_prn_application_fee_pdf_view, name="new_principle_prn_pdf_view"),
    path('prn/pdf/principle/download/<int:pk>', principle_prn_application_fee_pdf_download_view, name="new_principle_prn_pdf_download_view"),
    # licence fees
    path('prn/pdf/lincefee/principle/list/<int:pk>', principle_prn_licence_fee_pdf_view, name="new_principle_prn_licence_fee_pdf_view"),
    path('prn/pdf/lincefee/principle/download/<int:pk>', principle_prn_licence_fee_pdf_download_view, name="new_principle_prn_licence_fee_pdf_download_view"),

    # premise
    path('prn/pdf/premise/list/<int:pk>', premise_prn_pdf_view, name="new_premise_prn_pdf_view"),
    path('prn/pdf/premise/download/<int:pk>', premise_prn_pdf_download_view, name="new_premise_prn_pdf_download_view"),
   
    # certificate 
    path('certificate/new', NewCertificateList.as_view(), name="new_certificate_list"),
    # employee 
    path('certificate/pdf/employee/list/<int:pk>', employee_certificate_pdf_view, name="new_employee_certificate_pdf_view"),
    path('certificate/pdf/employee/download/<int:pk>', employee_certificate_pdf_download_view, name="new_employee_certificate_pdf_download_view"),
    # principle
    path('certificate/pdf/principle/list/<int:pk>', principle_certificate_pdf_view, name="new_principle_certificate_pdf_view"),
    path('certificate/pdf/principle/download/<int:pk>', principle_certificate_pdf_download_view, name="new_principle_certificate_pdf_download_view"),
    # premise
    path('certificate/pdf/premise/list/<int:pk>', premise_certificate_pdf_view, name="new_premise_certificate_pdf_view"),
    path('certificate/pdf/premise/download/<int:pk>', premise_certificate_pdf_download_view, name="new_premise_certificate_pdf_download_view"),
