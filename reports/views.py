...
class PrincipleLicencerevenueView(View):
    ...
    def get(self, request):
        ...
        principle = PrincipleLicence.objects.all()
...
class PremiseLicenceRevenueView(View):
    ...
    def get(self, request):
        ...
        premise = PremiseLicence.objects.all()
        ...
        context['premiselist'] = premise

        return render(request, self.template_name, context)


class EmployeeLicenceRevenueView(View):
    template_name = 'reports/revenue/applications_report.html'
    ...
    def get(self, request):
        ...
        data = EmployeeLicence.objects.all()
...
class RevenueReportView(View):
    template_name = 'reports/revenue/revenue_report.html'
...
class AllEmployees(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        premises = EmployeeLicence.objects.all().values_list(
            'name_of_the_company', 'name_of_the_employee', 'occupation', 'licence_number', 'prn', 'payment_description',
            'approving_authority_remarks',
        )
        # Create the table for user details
        premise_table_data = [
            ['Company Name', 'Employee name', 'Designation / Employee position', 'Licence Number', 'PRN', 'Payment',
             'Comments']]
...
class AllPrinciplePdfReport(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        premises = PrincipleLicence.objects.filter(approving_authority_status=approval_status).values_list(
            'name_of_the_company', 'licence_type', 'date_applied', 'applicationfeepayments__prn',
...
class AllPremisesPdfReport(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        premises = PremiseLicence.objects.filter(approving_authority_status=approval_status).values_list(
            'operator_name', 'trade_name', 'premise_name', 'region', 'district', 'municipality', 'town_council',
            'payment_description', 'approving_authority_status',
        )
        ...
        # Create the table for user details
        premise_table_data = [
            ['Operator Name', 'Trade name', 'Premise name', 'Region', 'District', 'Municipality', 'Town council',
             'Payment', 'Comments']]
