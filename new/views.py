    ...
    def post(self, request, *args, **kwargs):
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                application.save()
                messages.success(request, 'licence applied successfully')
                return redirect('new:new_prn_list')
            else:
                print(form.errors)
        return render(request, self.template_name, {'form': form})
...
class CreatePremise(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            form.save()
            return redirect('new:premise_list')
...
def view_pdf(request, pk):
    ...
    # premise_fee = locale.currency(premise.inspection_fee, grouping=True,  symbol=False, international=False )
...
def new_principle_certificate_pdf_view(request, pk, *args, **kwargs):
...
def new_principle_certificate_pdf_download_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(PrincipleLicence, pk=pk)
    # template_path = 'new/certificate/pdf_principle_certificate.html'
    # context = {
...
def new_employee_certificate_pdf_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(EmployeeLicence, pk=pk)
...
def new_employee_certificate_pdf_download_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(EmployeeLicence, pk=pk)
    # template_path = 'new/certificate/pdf_employee_certificate.html'
    # context = {
...
def new_premise_certificate_pdf_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
...
def new_premise_certificate_pdf_download_view(request, *args, **kwargs):
    pk = kwargs.get('pk')
    certificate = get_object_or_404(PremiseLicence, pk=pk)
    template_path = 'new/certificate/pdf_premise_certificate.html'
    context = {
...
def new_principle_prn_application_fee_pdf_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(PrincipleLicence, pk=pk)
    ...
    if slip.licence_type  == "License to conduct a National Lottery":
        ...
        p.drawString( 95, 578, "PPLICATION FEE FOR A BETTING MACHINE GENERAL OPERATING LICENCE" )
    elif slip.licence_type == "Gaming or betting machine techinical operating license":
        p.drawString( 95, 578,  "PPLICATION FEE FOR A BETTING MACHINE TECHINICAL OPERATING LICENCE"  )
        ...
        p.drawString( 95, 578, "PPLICATION FEE FOR A SOFTWARE OPERATING LICENCE "  )
    else:
        pass 
    ...
    locale.setlocale( locale.LC_ALL, 'de_DE' )
    application_fee = locale.currency(slip.application_fee, grouping=True,  symbol=False, international=False )
...
def new_principle_prn_application_fee_pdf_download_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(PrincipleLicence, pk=pk)
    # template_path = 'new/prns/principle_applicationfee_prnslip.html'
    # context = {
...
def new_principle_prn_licence_fee_pdf_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(PrincipleLicence, pk=pk)
    ...
    if slip.licence_type  == "License to conduct a National Lottery":
        ...
        p.drawString( 95, 578,  "TO BE SERVED")
    ...
    locale.setlocale( locale.LC_ALL, 'de_DE' )
    licence_fee = locale.currency(slip.licencefeepayments.licence_fee, grouping=True,  symbol=False, international=False )
...
def new_principle_prn_licence_fee_pdf_download_view(request, *args, **kwargs):
    pk = kwargs.get('id')
    certificate = get_object_or_404(PrincipleLicence, pk=pk)
    template_path = 'new/prns/principle_licencefee_prnslip.html'
    context = {
...
def new_employee_prn_pdf_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(EmployeeLicence, pk=pk)
    ...
    locale.setlocale( locale.LC_ALL, 'de_DE' )
    application_fee = locale.currency(premise.application_fee, grouping=True,  symbol=False, international=False )
...
def new_premise_prn_pdf_view(request, pk,  *args, **kwargs):
    ...
    locale.setlocale( locale.LC_ALL, 'de_DE' )
    inspection_fee = locale.currency(premise.inspection_fee, grouping=True,  symbol=False, international=False )
...
def new_premise_prn_pdf_download_view(request, pk, *args, **kwargs):
    # pk = kwargs.get('id')
    # certificate = get_object_or_404(PremiseLicence, pk=pk)
    # template_path = 'new/prns/premise_prnslip.html'
    # context = {
